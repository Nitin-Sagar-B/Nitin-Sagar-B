...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&duration=3000&pause=1000&color=8A2BE2&center=true&vCenter=true&width=435&lines=Backend+Engineer+%26+AI+Dev;Enterprise+Java+%26+Spring+Boot;Building+AI+tools+at+Sparkience+AI.;Let%27s+build+dope+things+together!"/>
</p>
...
🎓 BVRIT Alum (AI & Data Science) | 💻 Full-Time Backend Developer @ Accenture  
🔭 Currently building [**Sparkience AI**](https://github.com/Sparkience-AI) – my open-source AI lab in my free time  
💡 Passionate about production-grade Spring Boot systems, Agentic AI (Smolagents, LangChain), and secure API architectures  
💬 Down to collab on open-source AI tools, agentic workflows, and high-performance backend systems  
...
*   **Spark Insights:** An autonomous AI Data Scientist agent engineered with Smolagents to automate end-to-end data analysis workflows and generate insight-driven reporting pipelines.
*   **AI-Powered Decision Support System:** An enterprise forecasting platform built using Streamlit, Prophet, and Monte Carlo simulations for multi-scenario risk analysis.
